    ...
    <div id="resume" class="container mt-5">
        ...
        <div class="row mt-5">
            ...
            <div class="col-md-6">
                <div class="row">
                    ...
                    <div>
                        <p>
                            PHP, Laravel, Javascript, HTML 5, CSS 3, GitHub,
                            Git, VueJS, JQuery, WordPress, MySQL, OOP, PHPUnit,
                            Java, Spring
                        </p>
                    </div>
                    ...
                    <div>
                        <p>
                            Udacity Core Java Certification, Udemy web
        ...
        <div class="row">
            <div class="col">
                ...
                <div>
                    <p>
                        Full stack Web Developer providing services aimed to
                        help my clients achieve their goals. I also enjoy the
                ...
                <div>
                    <p>
                        I work in the meat/seafood department in Wholefoods. I
                        provide customer service and follow all the protocols
                ...
                <div>
                    <p>
                        Provided customer service, promoted as department manager.
                    </p>
                </div>
            </div>
            <div class="col"></div>
        ...
        <div class="row">
            <div class="col">
                ...
                <div><p>2017</p></div>
                <div class="mt-3"><h4>University of Alabama, Huntsville - Master Degree</h4></div>
                <div><p>2010 - History Degree</p></div>
                <div class="mt-3"><h4>Montclair State University - Bachelor Degree</h4></div>
